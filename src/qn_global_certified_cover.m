...
result=struct('verified',cert,'discarded',disc,'bisected',bis, ...
    ...
    'schema_version',3,'initial_box_ids',initial_box_ids', ...
    'source_commit',provenance.source_commit, ...
    'source_dirty',provenance.source_dirty, ...
    'source_code_sha256',provenance.source_code_sha256, ...
    'veigs_commit',provenance.veigs_commit,'run_id',provenance.run_id, ...
    'matlab_version',provenance.matlab_version, ...
    'matlab_release',provenance.matlab_release, ...
    'intlab_start_sha256',provenance.intlab_start_sha256, ...
    'intlab_tree_sha256',provenance.intlab_tree_sha256, ...
