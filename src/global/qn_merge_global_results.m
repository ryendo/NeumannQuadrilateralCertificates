...
[result.min_certified_margin,kmin]=min(cellfun(@(x)x.min_certified_margin,items));
...
result.complete=result.unverified==0 && result.initial_retained==result.initial_retained_all;
